...
/**
 * Referenced from https://superior-leo.gitee.io/2021/01/31/as-zhi-ce-hua-jie-mian-dai-ma/
 * Author: Superior Leo
 */
...
public class SlideMenuActivity extends FrameLayout {
    ...
    @Override protected void onFinishInflate() {
        super.onFinishInflate(); menuView = getChildAt(0);
     ...
     * @param r:当前子view的宽 * @param b:当前子view的高
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (newScrollX > 0) newScrollX = 0; scrollTo(newScrollX, 0);
                downX = moveX;
                break;
